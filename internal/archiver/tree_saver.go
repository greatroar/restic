...
type TreeSaver struct {
	saveTree func(context.Context, *restic.TreeBuilder) (restic.ID, ItemStats, error)
	errFn    ErrorFunc
...
func NewTreeSaver(ctx context.Context, t *tomb.Tomb, treeWorkers uint, saveTree func(context.Context, *restic.TreeBuilder) (restic.ID, ItemStats, error), errFn ErrorFunc) *TreeSaver {
